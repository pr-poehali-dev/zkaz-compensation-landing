...
const faq = [
  ...
  { q: 'Сколько времени займёт?', a: 'В среднем 6–8 месяцев от первого осмотра до получения денег.' },
];
          ...
          <div className="relative flex h-full flex-col p-7">
            ...
            <div className="flex items-center justify-between gap-4 rounded-2xl bg-white/10 p-4 my-2.5 px-[13px] py-[19px]">
              <div>
                ...
                <p className="text-white/60 my-1 py-0 px-0 text-xl">Или позвоните: +7 (995) 440-77-50 ; +7 (960) 891-68-88</p>
          ...
          <div className="flex h-full flex-col p-7">
            ...
            <div className="space-y-2 rounded-2xl bg-navy-deep p-4 text-white grain px-[3px] my-2">
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-0.5">
                ...
                <span className="font-display text-sm font-bold text-gold whitespace-nowrap">+7 (960) 772-48-88</span>
              </div>
