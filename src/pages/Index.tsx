...
const stats = [
  ...
  { value: '75 млн ₽', label: 'Взыскали за 2025 год для около 250 дольщиков', icon: 'TrendingUp' },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: 'В среднем 4–6 месяцев. Срок зависит от позиции застройщика и загруженности суда. На каждом этапе мы держим вас в курсе через ежемесячные отчёты.',
  },
  {
  ...
  },
  {
    ...
    a: 'Договор долевого участия, акт приёма-передачи и, по возможности, фотографии дефектов. Остальное — экспертизу и расчёты — подготовим мы.',
  },
  {
    ...
    <div className="min-h-screen bg-background font-sans text-navy">
      ...
      <section className="bg-navy-deep py-20 text-center text-white grain">
        <div className="container max-w-2xl">
          ...
          <p className="mt-4 text-white/70">Бесплатный осмотр и расчёт. Без предоплаты и обязательств.</p>
        ...
        <div className="container grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2"><Icon name="Phone" size={16} className="text-navy" /> +7 (900) 000-00-00</li>
              <li className="flex items-center gap-2"><Icon name="Mail" size={16} className="text-navy" /> hello@pravo-dolshchik.ru</li>
              <li className="flex items-center gap-2"><Icon name="MapPin" size={16} className="text-navy" /> г. Москва, ул. Правовая, 1</li>
            </ul>
          </div>
